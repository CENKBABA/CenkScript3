		...
		if "==" not in i and "!=" not in i and "=" in i:
			...
			if kntls==[]:
				...
				if fnk_çözüm!=[]:
					...
					ifd=fnk_ifade[-1]
					#print("baban",ifd,fnk_çözülecek,fnk_çözüm)
...
sy=mod(topla(topla(3,2),topla(7,3)),10)
...
fonksiyon asd(sy,sy2){
dön=n_topla(sy)+n_topla(10)
döndür dön
}
as=n_topla(n_topla(3))
