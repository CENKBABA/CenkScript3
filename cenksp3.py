...
#						döngü_id.append(satır)
			...
			if kntls=="":
				...
				#print("hass deneme",gecici)
				
				#print(listeli_ifade_çözücü("[2,3]!=[2]+[3]"))
...
yazdır uzunluk(a[1:-1])

b=[1,2,[20,[5,15],30,40],10,15]

yazdır b
b[2][1][-1]=(b[2][1][-1]*2)/10
...
def kod_optimize(kod):
	...
	for i in kod:
		...
		#print("adda",i,psy1,psy2)
		if i=="\n":
			satır=True
			if psy1==0 and psy2==0:
				dnd+="\n"
		if satır and (i==" " or i=="\t"):
			pass
		elif satır and i!="\n":
